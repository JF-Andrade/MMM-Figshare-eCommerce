...
> [!NOTE]
> The Ridge baseline may produce negative coefficients for correlated channels due to multicollinearity. This is a known limitation of linear regression and is resolved by the Bayesian model's positive priors.
